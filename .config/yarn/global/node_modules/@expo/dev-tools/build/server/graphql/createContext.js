...
exports.PROCESS_SOURCE = exports.ISSUES_SOURCE = void 0;
...
function createContext({ projectDir, messageBuffer, layout, issues }) {
    return {
        ...
        getSources() {
            ...
            const devices = (0, uniqBy_1.default)(chunks, ({ node }) => node.deviceId).map(({ node }) => ({
                __typename: 'Device',
                id: node.deviceId,
        ...
        getIssueIterator() {
            // @ts-ignore
            const iterator = (0, eventEmitterToAsyncIterator_1.default)(issues, ['ADDED', 'UPDATED', 'DELETED']);
            return {
                async next() {
